  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    try {
      if (isLogin) {
        ...
        setMessage({
          text: 'Confira seu e-mail para verificar sua conta.',
          type: 'success',
        });
      }
    } catch (error: any) {
          ...
          <div className="mt-6">
            ...
            <div className="mt-6">
              <button
                ...
                disabled={isLoading}
                className="flex w-full items-center justify-center gap-3 rounded-md border border-gray-300 bg-white py-2 px-4 text-sm font-medium text-gray-700 shadow-sm hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 disabled:opacity-75 disabled:cursor-not-allowed"
              >
